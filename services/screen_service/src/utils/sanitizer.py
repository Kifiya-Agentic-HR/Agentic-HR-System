...
def sanitizer(user_input: str) -> str:
    ...
    # 3. Remove LLM prompt-special tokens
    #    Matches things like <|token_name|> as well as >>> and <<< markers
